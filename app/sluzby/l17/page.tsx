            ...
            <FadeIn>
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="font-display font-bold text-cream text-2xl uppercase tracking-wide">Požadavky na mentora</h2>
                </div>
                <ul className="space-y-4">
                  {l17.requirements.map((req, i) => (
                    <li key={i} className="flex items-start gap-4 pb-4 border-b border-border last:border-0">
                      <span className="font-display font-black text-red text-lg leading-none w-5 shrink-0 mt-0.5">{i + 1}.</span>
            ...
            <FadeIn delay={0.1}>
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="font-display font-bold text-cream text-2xl uppercase tracking-wide">Pravidla programu</h2>
                </div>
                <ul className="space-y-4">
